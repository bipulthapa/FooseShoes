...
function Carousel(imageContainer,imageWrapper,pictureWidth,pictureHeight,hold){
    ...
    this.initialCssConfiguration = function(){
        ...
        this.imageWrapper.querySelectorAll('img:last-child')[0].style.marginRight = 0 + "px";
        ...
        this.leftSlider.style.maxWidth = 30+"px";
        ...
        this.rightSlider.style.maxWidth = 30+"px";
        ...
        for(var loop=0;loop<this.totalImageCount;++loop){
            ...
            this.roundCircle.style.maxWidth = 15 + "px";
...
var c1 = new Carousel(imageContainer,imageWrapper,300,180,1000);

c1.initialCssConfiguration();
c1.start();

var imageContainer = document.getElementsByClassName("carousel-container")[1];
var imageWrapper = document.getElementsByClassName("carousel-image-wrapper")[1];
var c2 = new Carousel(imageContainer,imageWrapper,300,180,2000);
c2.initialCssConfiguration();
c2.start();

var imageContainer = document.getElementsByClassName("carousel-container")[2];
var imageWrapper = document.getElementsByClassName("carousel-image-wrapper")[2];
var c3 = new Carousel(imageContainer,imageWrapper,300,180,3000);
c3.initialCssConfiguration();
c3.start();
...
// var c2 = new Carousel(imageContainer1,imageWrapper1,1100,460,2000);
